...
from qdax.core.emitters.mutation_operators import isoline_variation, n_isoline_variation
...
def main(config: DictConfig) -> None:
	...
	wandb.init(project="Thesis", name=f"AURORA-Standard-{currentdatetime}-{config.pattern_id}", config=OmegaConf.to_container(config, resolve=True))
	# Init a random key
