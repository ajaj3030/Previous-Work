    ...
    const handleSubmit = async (e) => {
        ...
        if (formValid) {
            try {
                ...
                //     setError(errorData.message); // Update with the appropriate error message from the API response
                // }
                ...
                setError("An error occurred. Please try again."); // Update with a general error message
            } finally {
                setLoading(false);
            }
        }
  ...
  return (
    <div className="relative isolate bg-white">
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        ...
        <form action="#" method="POST" className="relative z-10 px-6 pb-24 sm:pb-32 lg:px-8 lg:py-16" onSubmit={handleSubmit}>
            <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">

                <div className='mb-14'>
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900">Investors</h2>

                    {submittedSuccessfully ? (
                        <div>
                            <p className="mt-2 text-md leading-6 text-gray-600">
                                Thank you for getting in contact. We'll be in touch.
                            </p>
                        </div>
                    ) : (
                        <div>
                            <p className="mt-2 text-md leading-6 text-gray-600">
                                Want to know more about what we're building? Interested in meeting the team? Drop us a line here and we'll be in touch.
                            </p>
                        </div>
                    )}
                </div>
                ...
                {!submittedSuccessfully ? (
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div className="mt-1.5">
                                    ...
                                    className={`block w-full ${
                                        formSubmitted && !values.first_name ? "ring-1 ring-red-800/60" : ""
                                    } ${values.first_name ? "bg-blue-100/70 focus:bg-gray-100" : "bg-gray-100"} rounded-md px-3.5 py-2 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-800/60 sm:text-sm sm:leading-6`}
                                    />
                                </div>
                            </div>
                            {/* END FIRST NAME */}
                            ...
                            <div>
                                ...
                                <div className="mt-1.5">
                                    ...
                                    onChange={handleInputChange}
                                    className={`block w-full ${
                                        formSubmitted && !values.last_name ? "ring-1 ring-red-800/60" : ""
                                    } ${values.last_name ? "bg-blue-100/70 focus:bg-gray-100" : "bg-gray-100"} rounded-md px-3.5 py-2 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-800/60 sm:text-sm sm:leading-6`}
                                    />
                                </div>
                            </div>
                            {/* END LAST NAME */}
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-1.5">
                                    ...
                                    onChange={handleInputChange}
                                    className={`block w-full ${
                                        formSubmitted && !values.email ? "ring-1 ring-red-800/60" : ""
                                    } ${values.email ? "bg-blue-100/70 focus:bg-gray-100" : "bg-gray-100"} rounded-md px-3.5 py-2 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-800/60 sm:text-sm sm:leading-6`}
                                    />
                                </div>
                            </div>
                            {/* END EMAIL */}
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-1.5">
                                    ...
                                    type="text"
                                    id="company"
                                    placeholder="Victoria's Ventures"
                                    ...
                                    onChange={handleInputChange}
                                    className={`block w-full  ${
                                        formSubmitted && !values.company ? "ring-1 ring-red-800/60" : ""
                                    } ${values.company ? "bg-blue-100/70 focus:bg-gray-100" : "bg-gray-100"} rounded-md px-3.5 py-2 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-800/60 sm:text-sm sm:leading-6`}
                                    />
                                </div>
                            </div>
                            ...
                            <button
                            type="submit"
                            className={`block w-full rounded-md bg-blue-950 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 ${loading ? 'opacity-60' : ''}`}
                            >
                    ...
                    <Link to="/" className="block w-full rounded-md bg-blue-950 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                        Back to home
                    </Link>
                )}
            </div>
