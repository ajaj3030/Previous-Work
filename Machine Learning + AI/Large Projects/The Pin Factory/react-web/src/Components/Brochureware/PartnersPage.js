      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        ...
        <form action="#" method="POST" className="relative z-10 px-6 pb-24 sm:pb-32 lg:px-8 lg:py-16">
            <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                ...
                <div className='mb-14'>
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900">Become a partner</h2>
                    <p className="mt-2 text-md leading-6 text-gray-600">
                        Tell us about your company and what you are looking for. Our team will get back to you right away.
                    </p>
                </div>
