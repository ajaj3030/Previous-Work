...
#from ship import Ship, ShipFactory
...
class Board:
    ...
    def are_ships_too_close(self):
        ...
        for ship in self.ships:
            for other_ship in self.ships:
                if ship == other_ship:
                    pass
                elif ship.is_near_ship(other_ship):
                    return True
        return False
    ...
    def have_all_ships_sunk(self):
        ...
        sunk_ship_count = sum([ship.has_sunk() for ship in self.ships])
        return ship_count == sunk_ship_count
